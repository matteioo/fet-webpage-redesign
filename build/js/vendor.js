...
`, el);
  ...
  function src_default2(Alpine2) {
    const data2 = Alpine2.reactive({ screensize: window.innerWidth });
  ...
  module_default.store("darkMode", {
    theme: module_default.$persist("system"),
    setSystem() {
      this.theme = "system";
    },
    setLight() {
  ...
  module_default.data("bodyData", () => ({
    ...
    setThemeSystem() {
      module_default.store("darkMode").setSystem();
      console.log(this.$store.darkMode.theme);
    },
    setThemeLight() {
      module_default.store("darkMode").setLight();
      console.log(this.$store.darkMode.theme);
    },
    setThemeDark() {
      module_default.store("darkMode").setDark();
      console.log(this.$store.darkMode.theme);
    },
    isThemeDark() {
      return module_default.store("darkMode").isDark();
    },
    isThemeLight() {
      return module_default.store("darkMode").isLight();
    },
    documentRoot: {
      ":class"() {
  ...
  module_default.data("navBar", () => ({
    ...
    navBarThemeContentSystem: {
      ":class"() {
        return module_default.store("darkMode").getCurrentTheme() === "system" ? "activeTheme" : "";
      }
    },
    navBarThemeContentLight: {
      ":class"() {
        return module_default.store("darkMode").getCurrentTheme() === "light" ? "activeTheme" : "";
      }
    },
    navBarThemeContentDark: {
      ":class"() {
        return module_default.store("darkMode").getCurrentTheme() === "dark" ? "activeTheme" : "";
      }
    },
    navBarContentLg: {
      ["x-show"]() {
  ...
  module_default.data("pinnedPost", () => ({
    pin: false,
    showPin() {
      this.pin = true;
    },
  ...
  module_default.data("toggleList", function() {
    return {
  ...
  module_default.data("collapseContent", () => ({
  ...
  module_default.data("postNavigateArticle", () => ({
    buttonState: false,
    showButton() {
  ...
  module_default.data("optionsToggle", () => ({
    optionsState: false,
    showOptions() {
  ...
  module_default.data("discordInfoBox", () => ({
    showBox: true,
    hideInfoBox() {
      this.showBox = false;
    }
  }));
  module_default.data("footerCounter", () => ({
    counter: 0,
    increase() {
      this.counter++;
    },
